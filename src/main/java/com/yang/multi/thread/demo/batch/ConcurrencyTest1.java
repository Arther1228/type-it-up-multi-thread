package com.yang.multi.thread.demo.batch;
...
public class ConcurrencyTest1 {
    ...
    public static void main(String[] args) {
        ...
        ConcurrencyTest1 concurrencyTest1 = new ConcurrencyTest1();
        List<Long> valueList2 = concurrencyTest1.getValueList2(listKey);
